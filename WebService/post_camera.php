...
$zooming=$_GET['zooming'];
$purchase_date=$_GET['purchase_date'];

$sql1="INSERT INTO item_camera (item_id, subcat_id, user_id, brand, model, camera_type, zooming, purchase_date ) VALUES 
('$item_id','$scat_id', '$user_id','$brand', '$model', '$camera_type','$zooming,'$purchase_date')";
